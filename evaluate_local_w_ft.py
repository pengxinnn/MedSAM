...
from segment_anything_slimsam import sam_model_registry
...
parser.add_argument('--model_path', type=str,default = '/home/xinpeng/SlimSAM/checkpoints/vit_b_medslim_final_step2_0.5_global_gaussian.pth')
...
def main():
    ...
    MedSAM_OLD_CKPT_PATH = "/home/xinpeng/SlimSAM/checkpoints/medsam_vit_b.pth"
    sam_ckpt = torch.load(MedSAM_OLD_CKPT_PATH)
    ...
    torch.save(sam_ckpt, "/home/xinpeng/MedSAM/work_dir/medslimsam_local_77_model.pth")

    medsam_model = sam_model_registry['vit_p77'](checkpoint="/home/xinpeng/MedSAM/work_dir/medslimsam_local_77_model.pth")
